					...
					<section class="panel">
						...
						<div class="panel-body">
							...
							<c:url value="/themsanpham" var="themsanpham"></c:url>
								<form:form role="form" action="${themsanpham}"
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Mã danh mục</label> <form:input
											type="text" path="danhMuc" class="form-control"
											id="exampleInputEmail1"/>
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Tên sản phẩm</label> <form:input
											type="text" path="tensanpham" class="form-control"
											id="exampleInputEmail1"/>
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Avatar</label> <form:input
											type="file" path="hinhanh" class="form-control"
											id="exampleInputEmail1"/>
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Số lượng</label> <form:input
										    path="soluong" class="form-control"
											id="exampleInputEmail1"/>
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Mô tả</label> <form:textarea
											style="resize: none" rows="8" path="mota" class="form-control"
											id="exampleInputEmail1"/>
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Đơn giá</label> <form:input
											 path="dongia" class="form-control"
											id="exampleInputEmail1"/>
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Giảm giá</label> <form:input
											 path="giamgia" class="form-control"
											id="exampleInputEmail1"/>
									</div>
									
									<form:button class="btn btn-info">Thêm sản phẩm</form:button>
								</form:form>
							</div>
