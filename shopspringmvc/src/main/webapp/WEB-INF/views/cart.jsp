				...
				<table class="table table-condensed">
					<thead>
						<tr class="cart_menu">
							...
							<td class="total">Xóa giỏ hàng</td>
						</tr>
					</thead>
					<tbody>
			           ...
			           <c:forEach var="item" items="${Cart}">
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<a class="cart_quantity_up" href="<c:url value="TangCart/${item.value.sanPham.masanpham}"/>"> + </a>
									<input class="cart_quantity_input" type="text" name="quantity" id="quantity-cart-${item.key}" value="${item.value.quantity}" autocomplete="off" size="2">
									<a class="cart_quantity_down" href="<c:url value="GiamCart/${item.value.sanPham.masanpham}"/>"> - </a>
								</div>
							</td>
		                ...
		                <tr>
		                   <td class="cart_total">
								<p class="cart_quantity_delete">THÀNH TIỀN:</p><p class="cart_total_price"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${TotalPriceCart}" />VNĐ</p>
							</td>
		                </tr>
					</tbody>
				</table>
