...
<body>
 ...
 -->									<th>Mã danh mục</th>
								...
								<c:forEach items="${pagedListHolder.pageList}" var="tk">
								<tbody>
								   <c:url value="/danhmuc-update" var="urlUpdatedanhmuc"></c:url>
								   <c:url value="/taikhoan-delete" var="urlDeletetaikhoan"></c:url>
									<tr>
										<!-- <td><label class="i-checks m-b-none"><input
												type="checkbox" name="post[]"><i></i></label></td> -->
										<td>${tk.getMataikhoan()}</td>
										<td><span class="text-ellipsis">${tk.getTentaikhoan()}</span></td>
										<td><span class="text-ellipsis">${tk.getTendangnhap()}</span></td>
										<td><span class="text-ellipsis">${tk.getMatkhau()}</span></td>
										<td><span class="text-ellipsis">${tk.getDiachi()}</span></td>
										<%-- <td><a href="${urlUpdatedanhmuc}/${tk.getMataikhoan()}" class="active" ui-toggle-class=""><i
												class="fa fa-pencil-square-o text-success text-active" style="font-size: 25px"></i></a></td> --%>
										<td><a href="${urlDeletetaikhoan}/${tk.getMataikhoan()}" class="active" ui-toggle-class=""><i
