								...
								<tbody>
								   ...
								   <c:url value="/danhmuc-delete" var="urlDeletedanhmuc"></c:url>
									<tr>
										...
										<td>${hd.mahoadon}</td>
										<td><span class="text-ellipsis">${hd.hoten}</span></td>
										<td><span class="text-ellipsis">${hd.sodienthoai}</span></td>
										<td><span class="text-ellipsis">${hd.email}</span></td>
										<td><span class="text-ellipsis">${hd.diachi}</span></td>
										<!-- <td><a href="#" class="active" ui-toggle-class=""><i
												class="fa fa-pencil-square-o text-success text-active"></i></a></td> -->
										...
										<td><a href="${pageContext.request.contextPath }/donhang/chitietdonhang/${hd.mahoadon}"><span class="text-ellipsis" >Xem chi tiết</span></a></td>				
									</tr>
