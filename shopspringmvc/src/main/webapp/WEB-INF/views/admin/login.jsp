...
<div class="w3layouts-main">
	<h2>ĐĂNG NHẬP</h2>
		<form:form action="${pageContext.request.contextPath }/admin-login" method="post" modelAttribute="admin">
			...
			<!-- <span><input type="checkbox" />Nhớ tài khoản của tôi</span>
			<h6><a href="#">Quên Mật Khẩu?</a></h6>
				<div class="clearfix"></div> -->
				<form:button >Đăng Nhập</form:button>
		</form:form>
		<p>Bạn có tài khoản chưa ?<a href="${pageContext.request.contextPath }/dangky-form">Tạo tài khoản</a></p>
